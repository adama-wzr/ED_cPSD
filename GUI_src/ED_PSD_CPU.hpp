              ...
              char POI)
{
    ...
    */
    ...
    if (opts->verbose)
        qInfo("Particle-Size Distribution 2D:\n");
              ...
              char POI)
{
    ...
    */
    ...
    if (opts->verbose)
        qInfo("Pore-Size Distribution 2D:\n");
              ...
              int POI)
{
    ...
    */
    ...
    if (opts->verbose)
        qInfo("Particle-Size Distribution 3D:\n");
              ...
              int POI)
{
    ...
    */
    ...
    if (opts->verbose)
        qInfo("Pore-Size Distribution 3D:\n");
...
int Sim3D(options *opts)
{
    ...
    qInfo("File Read Properly.");

    // Perform selected simulations

    if (opts->partSD){
        qInfo("Running partSD_3D!");
